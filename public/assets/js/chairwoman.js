...
(function (window, document) {
    ...
    const target = current && current.src
        ? current.src.replace(/chairwoman\.js(?:[?#].*)?$/i, "/assets/js/leadership.js")
        : "/assets/js/leadership.js";

    const loader = document.createElement("script");
    loader.src = target;
    loader.async = false;
    loader.dataset.pmewLeadershipAlias = "/assets/js/chairwoman.js";
    loader.addEventListener("error", () => {
        window.__PMEW_LEADERSHIP_ALIAS_LOADING__ = false;
        console.error("[PMEW] chairwoman.js could not load leadership.js from " + target);
    }, { once: true });
