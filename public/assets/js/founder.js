...
(function (window, document) {
    ...
    const target = current && current.src
        ? current.src.replace(/founder\.js(?:[?#].*)?$/i, "/assets/js/leadership.js")
        : "/assets/js/leadership.js";

    const loader = document.createElement("script");
    loader.src = target;
    loader.async = false;
    loader.dataset.pmewLeadershipAlias = "/assets/js/founder.js";
    loader.addEventListener("error", () => {
        window.__PMEW_LEADERSHIP_ALIAS_LOADING__ = false;
        console.error("[PMEW] founder.js could not load leadership.js from " + target);
    }, { once: true });
